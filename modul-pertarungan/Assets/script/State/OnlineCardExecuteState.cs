...
{
	public class OnlineCardExecuteState:BattleState
	{
        

        public OnlineCardExecuteState(GameObject CurrentPlayer, BattleStateManager BattleManager, GameObject SelectedCard)
